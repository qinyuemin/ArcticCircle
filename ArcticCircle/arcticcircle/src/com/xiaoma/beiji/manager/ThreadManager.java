...
public class ThreadManager {
     ...
     *             如果delay小于等于0
     */
    public static final ScheduledFuture<?> scheduleWithFixedDelay(Runnable task, long initialDelay, long delay) {
     ...
     *             如果task为Null
     */
    public static final void executeInSingle(Runnable task) {
     ...
     *             如果task为Null
     */
    public static final <T> Future<T> submitInSingle(Runnable task, T result) {
     ...
     *             如果task为Null
     */
    public static final Future<?> submitInSingle(Runnable task) {
     ...
     *             如果task为Null
     */
    public static final <T> Future<T> submitInSingle(Callable<T> task) {
        return getSingleExecutor().submit(task);
    }
     ...
     * @param task
     */
    public static final void executeInBackground(Runnable task) {
     ...
     * @param task
     */
    public static final void executeInDbWriteThread(Runnable task) {
