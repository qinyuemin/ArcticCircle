 ...
 *
 */
public class FavoriteFriendShopFragment extends SimpleFragment implements AdapterView.OnItemClickListener {
    ...
    protected int getFragmentLayoutId() {
        return R.layout.fragment_favorte_friend_shop;
    }
    ...
    protected void loadData() {
        HttpClientUtil.Dynamic.dynamicFavoriteList(2, "", "", new AbsHttpResultHandler<JSONObject>() {
            @Override
